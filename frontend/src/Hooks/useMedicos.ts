...
export function useCreateMedico() {
	...
	return useMutation({
		...
		onSuccess: () => { qc.invalidateQueries({ queryKey: medicosKeys.all }); snackBar.success("Médico criado."); },
...
export function useUpdateMedico() {
	...
	return useMutation({
		...
		onSuccess: () => { qc.invalidateQueries({ queryKey: medicosKeys.all }); snackBar.success("Médico atualizado."); },
		onError: (e: any) => snackBar.error(e?.message ?? "Erro ao atualizar médico."),
	});
}
...
export function useDeleteMedico() {
	...
	return useMutation({
		...
		onSuccess: () => { qc.invalidateQueries({ queryKey: medicosKeys.all }); snackBar.success("Médico removido."); },
