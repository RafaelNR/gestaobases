...
function criarPadrao(str: string) {
	const accented = {
	...
	const accentReplacer = function (chr: any) {
...
export function buscarPalavra(palavra: string, palavraChave: string) {
	return !!palavra
		.toLocaleLowerCase()
		.match(criarPadrao(palavraChave.toLocaleLowerCase()));
}
