...
import { AddItemRequestDto, ChangeStatusRequestDto, UpdateItemRequestDto, CreateRequerimentoFarmaciaRequestDto, UpdateRequerimentoFarmaciaRequestDto } from '../dto/requerimento.dto';
...
export declare class FarmaciaController extends BaseController {
    ...
    create(dto: CreateRequerimentoFarmaciaRequestDto, user: IUser): Promise<IResponse<RequerimentoResult>>;
    enviar(id: string, user: IUser): Promise<IResponse<RequerimentoResult>>;
    update(id: string, dto: UpdateRequerimentoFarmaciaRequestDto, user: IUser): Promise<IResponse<RequerimentoResult>>;
