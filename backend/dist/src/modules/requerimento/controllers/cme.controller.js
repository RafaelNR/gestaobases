...
const TIPO = client_1.TipoRequerimento.CME;
const MODULO = 'RequerimentoCME';
let CmeController = class CmeController extends BaseController_1.BaseController {
    service;
    logService;
...
exports.CmeController = CmeController;
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Setor)([roles_decorator_1.TypeSetor.CME, roles_decorator_1.TypeSetor.Base]),
    __param(0, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CmeController.prototype, "findAll", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "findByFiltro", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], CmeController.prototype, "findByStatus", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Setor)([roles_decorator_1.TypeSetor.CME, roles_decorator_1.TypeSetor.Base]),
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Setor)([roles_decorator_1.TypeSetor.CME, roles_decorator_1.TypeSetor.Base]),
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, roles_decorator_1.Setor)([roles_decorator_1.TypeSetor.CME, roles_decorator_1.TypeSetor.Base]),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], CmeController.prototype, "enviar", null);
__decorate([
    (0, common_1.Put)(':id/status'),
    (0, roles_decorator_1.Setor)([roles_decorator_1.TypeSetor.CME]),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "changeStatus", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], CmeController.prototype, "delete", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "addItem", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "updateItem", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], CmeController.prototype, "removeItem", null);
exports.CmeController = CmeController = __decorate([
    (0, common_1.Controller)('requerimentos/cme'),
    __metadata("design:paramtypes", [requerimento_service_1.RequerimentoService,
        log_repository_1.LogService])
], CmeController);
//# sourceMappingURL=cme.controller.js.map