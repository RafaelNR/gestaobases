...
Object.defineProperty(exports, "CmeController", {
    enumerable: true,
    get: function() {
        return CmeController;
    }
});
...
const TIPO = _client.TipoRequerimento.CME;
const MODULO = 'RequerimentoCME';
let CmeController = class CmeController extends _BaseController.BaseController {
...
CmeController = _ts_decorate([
    (0, _common.Controller)('requerimentos/cme'),
    _ts_metadata("design:type", Function),
    _ts_metadata("design:paramtypes", [
