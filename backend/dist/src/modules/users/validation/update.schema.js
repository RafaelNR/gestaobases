...
const UpdateUserRequestSchema = (0, _zodopenapi.extendApi)(_zod.z.object({
    ...
    }).min(5, 'Nome de usuário deve conter pelo menos 5 caracteres.').max(190, 'Nome de usuário deve conter no max. 190 caracteres.'),
    nome: _zod.z.string({
        error: 'Nome é requerido'
    }).min(5, 'Nome deve conter pelo menos 5 caracteres.').max(190, 'Nome deve conter no max. 190 caracteres.'),
